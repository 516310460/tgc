<template>
  <div class="BuyInfo">
    ...
    >
      ...
      <template #title>
        <span class="fs32 font-bold clffffff">购买BTC</span>
      </template>
    </van-nav-bar>
    <van-pull-refresh
      v-if="orderState != 5"
    ...
    >
      ...
      <div v-if="orderState == 1">
        ...
        <div class="bk21252F rounded-sm my-1 p-1 fs28 cl868D9A shadow-lg">
          ...
          <div class="flex items-center justify-between my-1">
            <span>银行账号</span>
            <div class="clffffff flex items-center">
              <span>6217 9943 4000 9694 298</span>
              <img
                class="w-1 ml-1"
                v-clipboard:copy="'1111'"
                v-clipboard:success="onCopy"
          ...
          <div class="flex items-center justify-between mt-1 clCD7728 p-1 bk312922 rounded-sm fs24">
            平台不会自动扣款，请您打开相应的APP转账，请务必点击“已付款”，“请放币” 按钮
          </div>
        </div>
        ...
        <div class="bk21252F rounded-sm my-1 p-1 fs28 cl868D9A shadow-lg">
          ...
          <div class="flex items-start justify-between my-1 fs22">
            <div class="wh008 mt0125 flex-none bkffffff rounded-full"></div>
            <span class="ml-1">平台不会自动扣款，请您打开相应的APP转账，请务必点击“已付款”，“请放币” 按钮</span>
          </div>
          <div class="flex items-start justify-between my-1 fs22">
            <div class="wh008 mt0125 flex-none bkffffff rounded-full"></div>
            <span class="ml-1">请勿备注任何信息 <span class="clCD7728">BTC、ETH、OKEX、USDT</span> 以及其他数字资产名称于转账备注，防止造成您的汇款被拦截，银行卡被冻结等问题</span>
          </div>
          <div class="flex items-start justify-between my-1 fs22">
            <div class="wh008 mt0125 flex-none bkffffff rounded-full"></div>
            <span class="ml-1">大于5w以上的跨行汇款，请分批支付 <span class="clCD7728">(少于5w可及时到账)</span> </span>
          </div>
        </div>
        ...
        <div class="bk21252F rounded-sm my-1 p-1 fs28 cl868D9A shadow-lg">
          ...
          <div class="flex items-center justify-between my-1">
            <span>交易数量</span>
            <div class="clffffff flex items-center">
              <span>300.21 BTC</span>
            </div>
          </div>
          <div class="flex items-center justify-between my-1">
            <span>订单编号</span>
            <div class="clffffff flex items-center">
              <span>210601212726229</span>
            </div>
          </div>
      ...
      <div v-if="orderState == 2">
        <div class="flex items-center justify-between">
          <div>
            <p class="fs44 clffffff font-bold">等待卖家放币</p>
      ...
      <div v-if="orderState == 4">
        ...
        <div class="bk21252F rounded-sm my-1 p-1 fs28 cl868D9A shadow-lg">
          <div class="flex items-center justify-between clffffff fs36">购买BTC</div>
          <div class="flex items-center justify-between my-1">
            <span>交易总价</span>
            <div class="clffffff flex items-center fs36 cl02AD8F font-bold">
              ￥ 10,000.00
    ...
    >
      <div class="flex items-center space-x-1">
        ...
        <nuxt-link
          ...
          class="flex-1"
        >
          <div class="button button-2xl fs32 bk616A77 clffffff">
            申诉
          </div>
        </nuxt-link>
        <nuxt-link
    ...
    >
      <div class="text-center mt-12">
        ...
        <div class="font-bold mt-1">
          <span class="fs68">14.73</span>
          <span class="ml-1">USDT</span>
        </div>
        <p class="fs28 mt-1 mb-2">已存入您的钱包</p>
        <nuxt-link :to="`/${locale}`">
