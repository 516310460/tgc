<template>
  <div class="RAndWRecord">
    ...
    >
      ...
      <template #title>
        <span class="fs32 font-bold clffffff">闯关收益</span>
      </template>
    </van-nav-bar>
      ...
      >
        ...
        >
          ...
          <div
            v-for="index in 10"
            :key="index"
            class="clffffff bk21252F rounded-sm m-1 p-1"
          >
            <div class="flex items-center justify-between fs24 clffffff">
              <div class="flex items-center">
                <span>1号通天塔</span>
                <span class="ml-1">第 1 期</span>
              </div>
              <div class="text-right cl02AD8F">
                2077.9USDT
              </div>
            </div>
          </div>
