      ...
      <div id="kline_container">
        <div class="chart_container dark">
          ...
          <div id="chart_toolbar">
            <div class="symbol-title hidden" id="symbol_title" />
            <div class="chart_dropdown" style="margin-left: 3px;" id="chart_toolbar_periods_vert">
            ...
            <div class="hidden" id="chart_updated_time">
              <div id="sizeIcon" class="chart_BoxSize" />
            </div>
            <div
              id="chart_show_depth"
              class="chart_toolbar_button chart_str_depth_cap hidden"
            >
              深度图
            </div>
          </div>
