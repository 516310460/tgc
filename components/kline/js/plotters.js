...
export class LastVolumePlotter extends Plotter {
    ...
    Draw(context) {
        ...
        context.fill();
        context.strokeStyle = theme.getColor(themes.Theme.Color.Grid5);
        context.stroke();
        context.font = theme.getFont(themes.Theme.Font.Default);
        context.textAlign = "center";
        context.textBaseline = "middle";
        ...
        context.fillText(Util.fromFloat(v, 2), area.getCenter(), y + 2);
    }
...
export class LastClosePlotter extends Plotter {
    ...
    Draw(context) {
        ...
        context.fillText(Util.fromFloat(v, ds.getDecimalDigits()), area.getCenter(), y + 2);
    }
...
export class RangeSelectionPlotter extends NamedObject {
    ...
    Draw(context) {
        ...
        // y + 2 矫正上下居中
        context.fillText(Util.fromFloat(v, digits), area.getCenter(), y + 2);
    }
